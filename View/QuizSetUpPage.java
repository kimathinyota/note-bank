...
public class QuizSetUpPage extends JPanel {
	...
	public QuizSetUpPage(QuizSetUpEventHandler handler) {
		...
		this.createQuiz.addActionListener(handler::createQuiz);
		this.chooseTopic.addActionListener(handler::chooseTopic);
