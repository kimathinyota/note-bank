...
public class QuizResponsePage extends JPanel {
	...
	public QuizResponsePage(QuizResponseEventHandler handler, Idea idea) {
		...
		this.submitAnswer.addActionListener(handler::submit);
		this.viewPromptNotes.addActionListener(handler::viewPromptNote);
