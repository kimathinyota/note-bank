...
public class ViewNotesPage extends JPanel {
	...
	public String getCurrentNoteName() {
		...
		for(Note n: notes) {
			...
			//current note is a Model.TextExcerpt
	...
	public ViewNotesPage(ViewNotesEventHandler handler, boolean enableCreateIdeaFunctionality, List<Note>notes, String pathToDirectory) {
		...
		this.nextPage.addActionListener(handler::nextPage);
		this.prevPage.addActionListener(handler::previousPage);
		this.createIdea.addActionListener(handler::createIdea);
		this.addToIdeaCheckBox.addItemListener(handler::addToIdea);
		this.clearSelectToggleButton.addActionListener(handler::clearSelectToggle);
