...
public class ManageNoteBankPage extends JPanel {
	...
	/**
	 * Deletes a subject by removing the subject from each Note that maps to it.
	...
	/**
	 * Constructor for ManageNoteBankPage
	 * @param noteSubjectMap: stores all mappings from Note to list of subject
	 */
...
;		//Save and Delete buttons:
	...
	public void addMoveSelectedNotesToSubjectActionListener(ActionListener moveSelectedNotesToSubjectActionListener) {
		this.moveSelectedNotesToSubject.addActionListener(moveSelectedNotesToSubjectActionListener);
	}
}
