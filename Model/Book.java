...
public class Book extends Note {
	...
	public Book(Book globalBook, String selectedPages, String pathToSaveDirectory) throws IOException{
		super(globalBook.getName(), globalBook.getFile().getPath(), "Model.Book",pathToSaveDirectory);
	 ...
	 * @return -1 if Model.Book doesn't contain image, else returns indexOfImage
	 */
	...
	/**
	 * @return For Global: returns Model.Book: name,
	 * @return For non-Global: returns Model.Book: name (specifyPages)
	 */
