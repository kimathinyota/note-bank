...
public class UploadNotePage extends JPanel {
	...
	public void addChoosePDFActionListener(ActionListener choosePDFActionListener) {
		this.choosePDF.addActionListener(choosePDFActionListener);
	}
	
	public void addUploadPDFToBankActionListener(ActionListener UploadPDFToBankActionListener) {
		this.uploadPDFToBank.addActionListener(UploadPDFToBankActionListener);
	}
	
	public void addChooseImageActionListener(ActionListener chooseImageActionListener) {
		this.chooseImage.addActionListener(chooseImageActionListener);
	}
	
	public void addUploadImageToBankActionListener(ActionListener UploadImageToBankActionListener) {
		this.uploadImageToBank.addActionListener(UploadImageToBankActionListener);
	}
	...
	public void addBackActionListener(ActionListener backActionListener) {
		this.backUpload.addActionListener(backActionListener);
	}
	
	public void addTextUploadActionListener(ActionListener textUploadActionListener) {
		this.textUploadToBank.addActionListener(textUploadActionListener);
	}
	...
	public void resetImageNote() {
		...
		this.chosenImageLabel.setText("No Image Chosen");
	}
	...
	public UploadNotePage(String pathToDirectory) {
		this.chooseImage = null;
		this.chosenPDF = null;
		...
		uploadImageLabel = new JLabel("Upload an Image file");
			...
			// Image: [Choose Image] No Image chosen
